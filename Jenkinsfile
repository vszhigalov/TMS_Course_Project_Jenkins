pipeline {
    ...
    stages {
      ...
      stage('Checkout SCM') {
       ...
       stage("Ansible") {
            steps {
               ansiblePlaybook become: true, becomeUser: 'root', credentialsId: 'TMS-ireland.pem', disableHostKeyChecking: true, installation: 'Ansible', inventory: 'ec2.py', playbook: 'deploy.yml'
            }
          }
